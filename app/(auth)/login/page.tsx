    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0C0B0B] px-4 text-[#F2EFEA]">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="font-display text-2xl font-bold tracking-tight text-[#F2EFEA]">Welcome back</h1>
        ...
        <p className="text-center text-sm text-[#F2EFEA]/62">
          ...
          <Link href="/register" className="font-medium text-[#F2EFEA] hover:underline">
            Sign up
          </Link>
        </p>
      </div>
